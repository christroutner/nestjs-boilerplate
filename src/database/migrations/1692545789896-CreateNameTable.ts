...
export class CreateNameTable1692545789896 implements MigrationInterface {
    name = 'CreateNameTable1692545789896'
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_4b58d5137d1d27a07744cdbb1b"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_31bb980dec6378b851a9ebe5bc"`);
